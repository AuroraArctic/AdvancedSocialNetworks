...
WPJ6W <- (WPJ>5)*(WPJ-5) # Only consider a tie in tie matrix, but only if major than 5 and then rescale it by removing 5
```
...
```{r}
# 4. Draw the friendship network using the coordinates got from nominal friendship
par(mar=c(0,0,0,0))
gplot(KHFSn,
      gmode="graph",
      #layout
