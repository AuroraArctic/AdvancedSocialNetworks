...
knitr::include_graphics("images/01-Introduction/Untitled.png")
```
...
*Note that whenever the adjacency matrix is symmetric and square with respect to the diagonal, we're looking at an undirected network, while if it is not so, we're looking at a directed network.*
