...
<aside>
💡 *In the Simpsons example, where there are 18 edges and 10 nodes, the density equals* $D = 18/(10*9/2) = 18/45 = 0.4$.
...
**Centralization** is a question about how central some nodes are compared to other nodes and therefore can be considered as a characteristic of the network itself. It is related to the distribution of the centrality inside the network, while centrality is more related to the individual sphere of the nodes. 
...
<aside>
💡 *Still, if we consider Friends' network, we notice that related to the out-degree centralisation, the network is kind of centralized on Rachel, which is talkative with everybody:*
