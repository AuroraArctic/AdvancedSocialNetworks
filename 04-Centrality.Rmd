...
```{r, echo=FALSE, fig.align='center', fig.pos='h!', out.width='50%', fig.cap=""}
knitr::include_graphics("images/04-Centrality/Untitled 2.png")
```
...
knitr::kable(data.frame(cbind(Name = get.vertex.attribute(Simpsons_n, "vertex.names"),
...
df = data.frame(
    "Name" = get.vertex.attribute(Simpsons_n, "vertex.names"),
    `Reciprocal Closeness Centrality` = sna::closeness(Simpsons_n2, gmode="graph", cmode="suminvundir"))
...
```{r}
cbind(get.vertex.attribute(Simpsons_n, "vertex.names"),
...
knitr::include_graphics("images/04-Centrality/Untitled 7.png")
```